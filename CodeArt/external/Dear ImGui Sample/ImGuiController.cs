...
namespace Dear_ImGui_Sample
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        public unsafe ImGuiController(int width, int height)
        {
            ...
            var jetBrains = ImGui.GetIO().Fonts.AddFontFromFileTTF(Helper.AssetsPath + "JetBrainsMono-Regular.ttf", 20);
            io.Fonts.AddFontDefault(jetBrains.ConfigData);
            jetBrains.NativePtr->Scale = .75f;
